        ...
        <div class="col-lg-6 col-lg-offset-3">
            <form action="proses.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <option value="">-Pilih-</option>
                    <?php
                        $sql_dokter = mysqli_query($con, "SELECT * FROM dokterr ORDER BY nama_dokter ASC") or die (mysqli_error($con));
                    while($data_dokter = mysqli_fetch_array($sql_dokter)) {
                        echo '<option value="'.$data_polidokter['id_dokter'].'">'.$data_dokter['nama_dokter'].'</option>';
                    }
                    ?>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <option value="">-Pilih-</option>
                    <?php
                        $sql_poli = mysqli_query($con, "SELECT * FROM poliklinik ORDER BY nama_poli ASC") or die (mysqli_error($con));
                ...
                <div class="form-group">
                    ...
                    <?php
                        $sql_obat = mysqli_query($con, "SELECT * FROM obat ORDER BY nama_obat ASC") or die (mysqli_error($con));

<?php
    ...
    if(isset($_POST['add'])) {
       ...
       mysqli_query($con, "INSERT INTO rekammedis (id_rm, id_pasien, keluhan, id_dokter, diagnosa, id_poli, tgl_periksa) VALUES ('$uuid', '$pasien', '$keluhan', '$dokter', '$diagnosa', '$poli', '$tgl')" ) or die (mysqli_error($con));
      
       $obat = $_POST['obat'];
       foreach ($obat as $ob) {
           mysqli_query($con, "INSERT INTO rm_obat") or die (mysqli_error($con));
       }

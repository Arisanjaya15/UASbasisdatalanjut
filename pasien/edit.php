...
<div class="box">
    ...
    <div class="row">
        <div class="col-lg-6 col-lg-offset-3">
            <?php
                $id = @$_GET['id'];
                $sql_pasien = mysqli_query($con, "SELECT * FROM pasien WHERE id_pasien ='$id'") or die(mysqli_error($con));
            ...
            <form action="proses.php" method="post">
                <div class="form-group">
                    ...
                    <input type="number" name="identitas" id="identitas" class= "form-control" value="<?=$data['nomor_identitas']?>" <?=$data['id_pasien']?> required  autofocus>
                </div>
                <div class="form-group">

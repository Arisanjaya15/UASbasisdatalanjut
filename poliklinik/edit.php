        ...
        <div class="col-lg-8 col-lg-offset-2">
            <form action="proses.php" method="post">
                ...
                <table class="table">
                    ...
                    $no=1;
                    foreach($chk as $id){
                            $sql_poli = mysqli_query($con, "SELECT * FROM poliklinik WHERE id_poli = '$id'") or die (mysqli_error());
                ...
                <div class="form-group pull-right">
                        <input type="submit" name="edit" value="Simpan Semua" class="btn btn-succsess">
                </div>
            </form>
            </div>
        </div>
